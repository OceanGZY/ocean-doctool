  ...
  <a-tabs defaultActiveKey="1">
    <a-tab-pane tab="网格" key="1">
      <a-row align="middle">
        ...
        <a-col :span="12">
          <a-select style="width: 100%" :value="globalGridAttr.type" @change="(val: any) => {
      ...
      <a-row align="middle">
        ...
        <a-col :span="10">
          <a-slider :min="1" :max="20" :step="1" :value="globalGridAttr.size" @change="(val: any) => {
      ...
      <div v-if="globalGridAttr.type === 'doubleMesh'">
        <a-row align="middle">
          ...
          <a-col :span="12">
            <a-input type="color" :value="globalGridAttr.color" style="width: 100%" @change="(e: any) => {
        ...
        <a-row align="middle">
          ...
          <a-col :span="10">
            <a-slider :min="0.5" :max="10" :step="0.5" :value="globalGridAttr.thickness" @change="(val: any) => {
        ...
        <a-row align="middle">
          ...
          <a-col :span="12">
            <a-input type="color" :value="globalGridAttr.colorSecond" style="width: 100%" @change="(e: any) => {
        ...
        <a-row align="middle">
          ...
          <a-col :span="10">
            <a-slider :min="0.5" :max="10" :step="0.5" :value="globalGridAttr.thicknessSecond" @change="(val: any) => {
        ...
        <a-row align="middle">
          ...
          <a-col :span="10">
            <a-slider :min="1" :max="10" :step="1" :value="globalGridAttr.factor" @change="(val: any) => {
    ...
    <a-tab-pane tab="背景" key="2">
      <a-row align="middle">
        ...
        <a-col :span="14">
          <a-input type="color" :value="globalGridAttr.bgColor" style="width: 100%" @change="(e: any) => {
      ...
      <a-row align="middle">
        <a-col :span="14" :offset="6">
          <a-checkbox :checked="globalGridAttr.showImage" @change="(e: any) => {
      ...
      <div v-if="globalGridAttr.showImage">
        <a-row align="middle">
          ...
          <a-col :span="14">
            <a-select style="width: 100%" :value="globalGridAttr.repeat" @change="(val: any) => {
        ...
        <div v-if="globalGridAttr.repeat === 'watermark'">
          <a-row align="middle">
            ...
            <a-col :span="14" :offset="6">
              <a-slider :min="0" :max="360" :step="1" :value="globalGridAttr.angle" @change="(val: any) => {
        ...
        <a-row align="middle">
          ...
          <a-col :span="14">
            <a-select style="width: 100%" :value="globalGridAttr.position" @change="(val: any) => {
        ...
        <a-row align="middle">
          ...
          <a-col :span="14">
            <a-select style="width: 100%" :value="globalGridAttr.bgSize" @change="(val: any) => {
              ...
              <a-select-option :value="JSON.stringify({ width: 150, height: 150 })"> {`{width: 150, height: 150 }`}
              </a-select-option>
            </a-select>
          </a-col>
        </a-row>
        <a-row align="middle">
          ...
          <a-col :span="12">
            <a-slider :min="0.05" :max="1" :step="0.05" :value="globalGridAttr.opacity" @change="(val: any) => {
